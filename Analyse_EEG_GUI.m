function [err] =Analyse_EEG_GUI(DetectorSettings,ProgramType)
                ...
                for j = 1:Number_of_windows % Loop through the number of windows in the data
                    ...
                    if (exist('All_Channel_Data','var')) % Check whether data has been inserted into All_Channel_Data
                        ...
                        elseif ProgramType(2) ==1 % Seizure Characterise
                            Analyse_data_characterise(All_Channel_Data,window_length,frequency_bands,fs,k,j,Start,DetectorSettings,Severity) % Analyse data, results are sent to spreadsheets
                        else
