...
function Analyse_data_plot(data,window_length,frequency_bands,sampling_frequency,dataIn,Channel,Channel_number_base,Animal_number,j)

[Crossings Crossing_time] = ZeroCrossingDetector(Data_out,window_length,fs,interleave);
...
plot_frequency = plot_spectral_analysis_characterise(window_length, splits, frequency_bands, frequency_output(:,1,:),Crossings,Crossing_time,data,t,dataIn,Channel,Channel_number_base,Animal_number,j);
...
function plot_spectral_analysis_characterise(window_length, splits, bands, frequency_analysis,Crossings,Crossing_time,data,t,dataIn,Channel,Channel_number_base,k,j)
