function [b,a] = firfilter(N,Wn,varargin)
...
%   If empty or omitted, FIR1 uses a hamming1 window of length N+1.
...
%
%   See also KAISERORD, FIRCLS1, FIR2, firls1, FIRCLS, CFIRPM,
...
%DESIREDFREQ  Compute the vector of frequencies to pass to firls1.
%
%   Inputs:
...
%           ff     - vector of frequencies to pass to firls1.
...
%DESIREDMAG  Compute the magnitude vector to pass to firls1.
